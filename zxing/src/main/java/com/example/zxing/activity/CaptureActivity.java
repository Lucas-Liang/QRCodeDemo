...
import com.example.zxing.utils.AlexStatusBarUtils;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    private ImageView scanner_toolbar_flash;
    private ImageView scanner_toolbar_open_img;
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    private void addToolbar() {
        ...
        scanner_toolbar_flash = (ImageView) findViewById(R.id.scanner_toolbar_flash);
        scanner_toolbar_flash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(isOpenFlash){
                    scanner_toolbar_flash.setImageResource(R.mipmap.flash_off);
                    Toast.makeText(CaptureActivity.this, "闪光灯关闭", Toast.LENGTH_SHORT).show();
                    isOpenFlash = false;
                }else {
                    scanner_toolbar_flash.setImageResource(R.mipmap.flash_on);
                    Toast.makeText(CaptureActivity.this, "闪光灯打开", Toast.LENGTH_SHORT).show();
                    isOpenFlash = true;
                }
        ...
        scanner_toolbar_open_img = (ImageView) findViewById(R.id.scanner_toolbar_open_img);
        scanner_toolbar_open_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        AlexStatusBarUtils.setTranslucentStatusBar(this, toolbar, 0);
    }
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            Log.e("", "handleDecode: >>>>>>>>>>>>>>>>>>>>>>>" + resultString);
